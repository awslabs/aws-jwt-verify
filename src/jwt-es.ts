...
function validateJwtHeaderAndJwk(
  ...
  // Check that the JWK is in fact a JWK for ES signatures
...
> {
   ...
   */
  static create<T extends JwtEsVerifierProperties<VerifyProperties>>(
    verifyProperties: T & Partial<JwtEsVerifierProperties<VerifyProperties>>,
   ...
   * @returns An ES JWT Verifier instance, that you can use to verify JWTs with
   */
  static create<T extends JwtEsVerifierMultiProperties<VerifyProperties>>(
    verifyProperties: (T &
      Partial<JwtEsVerifierProperties<VerifyProperties>>)[],
    additionalProperties?: { jwksCache: JwksCache }
  ...
  static create(
    verifyProperties:
      | JwtEsVerifierProperties<VerifyProperties>
      | JwtEsVerifierMultiProperties<VerifyProperties>[],
    additionalProperties?: { jwksCache: JwksCache }
  ) {
