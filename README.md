...
These tokens can be validated with the generic `JwtVerifier`, specifying the identity pool's ID as the `audience` and Cognito itself as the `issuer`.
